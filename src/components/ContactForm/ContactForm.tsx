...
const ContactForm = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='flex flex-col justify-center items-center gap-4 rounded-[30px] w-[50rem] h-[32.813rem] shadow-form mx-auto animate-open-section-form'>
